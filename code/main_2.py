...
from routenet_model_occu_2 import RouteNetModelOccu_2
...
model = RouteNetModelOccu_2(config)
...
ckpt_dir = config['DIRECTORIES']['logs_model2']
...
np.save('history_training_model2.npy', history.history)